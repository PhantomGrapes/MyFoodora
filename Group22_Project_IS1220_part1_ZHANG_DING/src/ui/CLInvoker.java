...
public class CLInvoker {
	...
	public CommandResult showTotalProfitInAPeriod(String[] args) throws Exception{
		if(args.length != 2)
			return invalidInput();
	...
	public CommandResult runTest(String[] args) throws Exception{
		if(args.length != 1)
			return invalidInput();
	...
	public CommandResult help(String[] args) throws Exception{
		if(args.length != 0)
			return invalidInput();
